        ...
        <form action="<?php echo site_url('Register/PracCreate')?>" method="post" enctype="multipart/form-data">
            <div class="container">
                ...
                <label> Confirm Password </label> 
                    <input type="text"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Password must contain at least 8 characters, an uppercase letter, a number, a lowercase letter" name="confirmpassword" placeholder="Password" size="20" required /> 
