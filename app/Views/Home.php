        ...
        <section>
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" style="height: 90vh;">
                ...
                <div class="carousel-inner">
                    ...
                    <img src="/public/assets/img/slide1.jpeg" class="d-block w-100" alt="banner1">
                    </div>
                    <div class="carousel-item">
                    <img src="/public/assets/img/slide2.jpeg" class="d-block w-100" alt="banner2">
                    </div>
                    <div class="carousel-item">
                    <img src="/public/assets/img/slide3.jpeg" class="d-block w-100" alt="banner3">
                    </div>
                    <div class="carousel-item">
                    <img src="/public/assets/img/slide4.jpeg" class="d-block w-100" alt="banner4">
                    </div>
                </div>
                    ...
                    <div class="col">
                        <div class="row row-cols-2">
                            ...
                            <div class="col" style="width:18rem">
                                <img src="../public/assets/img/vision.jpg" alt="visionImg" class="card-img-top">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="row row-cols-2">
                            <div class="col" style="width: 18rem;">
                                <img src="../public/assets/img/mission.jpg" alt="missionImg" class="card-img-top">
                            </div>
                            <div class="col">
                                <h3>Our Mission</h3>
